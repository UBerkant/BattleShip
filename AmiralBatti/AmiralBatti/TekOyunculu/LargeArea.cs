...
{
    public partial class LargeArea : Form
    {
        public LargeArea()
        {
            InitializeComponent();
        ...
        public void yazdir(object sender, EventArgs e)
        {
            ...
            KonumBilgisiNumeric.Value = int.Parse(dButton.Name);
        ...
        {
            int vurulan_konum = int.Parse(KonumBilgisiNumeric.Value.ToString());
            for (int i = 0; i < max_gemi; i++)
            {
        ...
        {
            secilen_konum = int.Parse(KonumBilgisiNumeric.Value.ToString());
        ...
        private void LargeArea_Load(object sender, EventArgs e)
        {
            ShipCounterLabel.Text = "0";
            WinnerLabel.Text = "";
            KonumBilgisiNumeric.Value = 1;
